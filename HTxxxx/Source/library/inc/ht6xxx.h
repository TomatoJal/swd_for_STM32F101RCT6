...
typedef struct
{
    __O  uint32_t PowerInQ;                    /*!< Offset: 0x000  无功功率输入寄存器(R/W)*/
    __O  uint32_t PowerInP;                    /*!< Offset: 0x004  有功功率输入寄存器(R/W)*/
    __O  uint32_t HFConst;                     /*!< Offset: 0x008  输出脉冲频率设置寄存器(R/W)*/
    __I  uint32_t EnergyP;                     /*!< Offset: 0x00C  有功能量缓存寄存器(R)  */
    __I  uint32_t EnergyQ;                     /*!< Offset: 0x010  无功能量缓存寄存器(R)  */
    __IO uint32_t ReadCtrl;                    /*!< Offset: 0x014  能量读取控制寄存器(R/W)*/
...
#define  TBS_TBSPRD_TMPPRD_OSC0P5S_MEM8S         ((uint32_t)0x0000)           /*!<TMP周期 = 0.5s  */
#define  TBS_TBSPRD_TMPPRD_OSC1S_MEM4S           ((uint32_t)0x0001)           /*!<TMP周期 = 1s  */
#define  TBS_TBSPRD_TMPPRD_OSC2S_MEM2S           ((uint32_t)0x0002)           /*!<TMP周期 = 2s  */
#define  TBS_TBSPRD_TMPPRD_OSC4S_MEM1S           ((uint32_t)0x0003)           /*!<TMP周期 = 4s  */
#define  TBS_TBSPRD_TMPPRD_OSC8S_MEM0P5S         ((uint32_t)0x0004)           /*!<TMP周期 = 8s  */
#define  TBS_TBSPRD_TMPPRD_OSC16S_MEM125mS       ((uint32_t)0x0005)           /*!<TMP周期 = 16s*/
#define  TBS_TBSPRD_TMPPRD_OSC32S_MEM31mS        ((uint32_t)0x0006)           /*!<TMP周期 = 32s  */
#define  TBS_TBSPRD_TMPPRD_OSC64S_MEM8mS         ((uint32_t)0x0007)           /*!<TMP周期 = 64s  */
...
#define  CMU_C_PLL_39M                           ((uint32_t)0xA500)           /*!<PLL时钟频率为39.845888MHz */
#define  CMU_C_PLL_40M                           ((uint32_t)0xA501)           /*!<PLL时钟频率为40.894464MHz */
#define  CMU_C_PLL_41M                           ((uint32_t)0xA502)           /*!<PLL时钟频率为41.943040MHz */
#define  CMU_C_PLL_42M                           ((uint32_t)0xA503)           /*!<PLL时钟频率为42.991616MHz */
#define  CMU_C_PLL_44M                           ((uint32_t)0xA504)           /*!<PLL时钟频率为44.040192MHz */
#define  CMU_C_PLL_45M                           ((uint32_t)0xA505)           /*!<PLL时钟频率为45.088768MHz */
#define  CMU_C_PLL_46M                           ((uint32_t)0xA506)           /*!<PLL时钟频率为46.137344MHz */
#define  CMU_C_PLL_47M                           ((uint32_t)0xA507)           /*!<PLL时钟频率为47.185920MHz */
#endif
